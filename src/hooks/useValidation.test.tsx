...
describe('useValidation', () => {
    ...
    it('should return an error for password less than 6 characters', () => {
        ...
        expect(result.current.inputErrors).toEqual({ password: 'Password must be at least 6 characters' });
    });
    ...
    it('should return an error for password without a number', () => {
        ...
        expect(result.current.inputErrors).toEqual({ password: 'Password must contain at least one number' });
    });
    ...
    it('should return an error for password without a letter', () => {
        ...
        expect(result.current.inputErrors).toEqual({ password: 'Password must contain at least one letter' });
    });
